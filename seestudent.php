...
<h3 style="text-align:center;">See All Students</h3>
	
		<table>
		
			<tr>
				<th width="150px">Student ID:<br><hr></th>
				<th width="250px">Student FNAME:<br><hr></th>
				<th width="150px">Student LNAME:<br><hr></th>
        <th width="150px">Student Address:<br><hr></th>
     
			</tr>
					
			<?php
			$sql = mysqli_query($link, "SELECT `Student_ID`, `Student_FNAME`, `Student_LNAME`, `Student_Address`, `Medical_Information` FROM `Student` WHERE 1");
