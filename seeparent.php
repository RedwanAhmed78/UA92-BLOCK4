  ...
  <div style="text-align:center;"class="navbar">
   ...
   <!-- Students-->
    ...
    error_reporting(E_ALL);
		    ...
		    $links = mysqli_connect("sdb-56.hosting.stackcp.net", "student102-353031337b8a", "ua92-studentAc", "student102-353031337b8a");
		    // Check connection
		    if ($links === false) {
		...
		<h3 style="text-align:center;">See All Parents</h3>
	
		<table>
		
			<tr>
				<th width="150px">Parents ID:<br><hr></th>
				<th width="250px">Parents FNAME:<br><hr></th>
				<th width="150px">Parents LNAME:<br><hr></th>
        <th width="150px">Parents Address:<br><hr></th>
        <th width="150px">Parents Telephone:<br><hr></th>

			</tr>
					
			<?php
			    $sql = mysqli_query($links, "SELECT `Parents_ID`, `Parents_FNAME`, `Parents_LNAME`, `Parents_Address`, `Student_ID`, `Parents_Telephone`, `Email` FROM `Parents`");
