...
<head>
  ...
  <hr>
	...
	<h3 style="text-align:center;">Update a Class</h3>
  <hr>
    ...
    <form method="post" action="UpdateClass.php">
		...
		<input type="varchar" name="Class_NAME">
		<br>
    ...
    if (isset($_POST['submit'])) {
         ...
         $sql = "UPDATE Class SET Class_NAME = '$Class_NAME', Year = '$Year', Capacity= '$Capacity' WHERE Class_ID = '$Class_ID'"; 
